...
class MLQADataset(datasets.GeneratorBasedBuilder):
    ...
    subsets = ["mlqa-translate-test.vi", 
        ...
        if (name_split[0].startswith("mlqa-translate-train")):
            ...
            return [
                datasets.SplitGenerator(
                    ...
                    gen_kwargs={
                        "filepath": f"{name_split[0]}/vi_squad-translate-train-train-v1.1.json",
                ...
                datasets.SplitGenerator(
                    ...
                    gen_kwargs={
                        "filepath": f"{name_split[0]}/vi_squad-translate-train-dev-v1.1.json",
                        "files": dl_manager.iter_archive(data_path),
                        "split": "test",
                    },
                ),
            ...
            return [
                datasets.SplitGenerator(
                    name=datasets.Split.TEST,
                    gen_kwargs={
                        "filepath": f"{name_split[0]}/translate-test-context-vi-question-vi.json",
                        "files": dl_manager.iter_archive(data_path),
                        "split": "test",
                    },
                ),
