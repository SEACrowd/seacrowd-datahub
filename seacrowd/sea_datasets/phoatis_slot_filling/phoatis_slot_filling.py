...
_SUPPORTED_TASKS = [Tasks.SLOT_FILLING]
...
class PhoATIS(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS.extend([config_constructor("seacrowd_seq_label", _SOURCE_VERSION, schema) for schema in ["syllable", "word"]])

    BUILDER_CONFIGS.extend(
        [  # Default config
            SEACrowdConfig(
                name="phoatis_slot_filling_source",
                version=SOURCE_VERSION,
                description="PhoATIS Slot Filling source schema (Syllable version)",
                schema="source",
                subset_id="syllable",
            ),
            SEACrowdConfig(
    ...
    DEFAULT_CONFIG_NAME = "phoatis_slot_filling_source"
