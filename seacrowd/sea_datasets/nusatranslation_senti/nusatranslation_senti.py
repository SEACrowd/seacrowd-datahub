...
def seacrowd_config_constructor(lang, schema, version):
    """Construct SEACrowdConfig with nusatranslation_senti_{lang}_{schema} as the name format"""
...
class NusaTranslationSenti(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: datasets.DownloadManager) -> List[datasets.SplitGenerator]:
        ...
        if self.config.name == "nusatranslation_senti_source" or self.config.name == "nusatranslation_senti_seacrowd_text":
