...
_URLS = {
    "audio": "https://huggingface.co/datasets/vivos/blob/main/data/vivos.tar.gz",
    "train_prompt": "https://huggingface.co/datasets/vivos/blob/main/data/prompts-train.txt.gz",
    "test_prompt": "https://huggingface.co/datasets/vivos/blob/main/data/prompts-test.txt.gz",
}
