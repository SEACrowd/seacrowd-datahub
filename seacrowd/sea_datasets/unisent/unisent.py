...
_LANGUAGES = [
    ...
    "bto", "bts", "btx", "bug", "bvz", "bzq", "bzi", "cbk", "ceb", "cfm",
    ...
    "mrw", "msb", "msk", "msm", "mta", "mtg", "wmm", "mtj", "mvp", "mwq",
    "mwv", "mya", "nbe", "nfa", "nia", "nij", "nlc", "ntx", "npy", "obo",
    "pag", "pam", "plw", "pmf", "pne", "ppk", "prf", "prk", "ptu", "pww",
    "sas", "sbl", "sda", "sgb", "smk", "sml", "sun", "sxn", "szb", "tbl",
    "tby", "tcz", "tdt", "tgl", "tha", "tih", "tlb", "twu", "urk", "vie",
    "war", "whk", "wrs", "xbr", "yli", "yva", "zom", "zlm", "zyp", "pse",
